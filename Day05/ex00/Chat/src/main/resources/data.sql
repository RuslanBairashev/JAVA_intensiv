...
insert into message (author, room, text, date, time) values(1,5,'test1', null, null);
insert into message (author, room, text, date, time) values(2,4,'test1', null, null);
insert into message (author, room, text, date, time) values(3,3,'test1', null, null);
insert into message (author, room, text, date, time) values(4,2,'test2', null, null);
insert into message (author, room, text, date, time) values(5,1,'test2', null, null);
