...
insert into message (author, room, text, date_time) values(1,5,'test1', current_timestamp);
insert into message (author, room, text, date_time) values(2,4,'test1', current_timestamp);
insert into message (author, room, text, date_time) values(3,3,'test1', current_timestamp);
insert into message (author, room, text, date_time) values(4,2,'test2', current_timestamp);
insert into message (author, room, text, date_time) values(5,1,'test2', current_timestamp);
